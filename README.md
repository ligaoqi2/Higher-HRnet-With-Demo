# [HigherHRNet with Runnable Demo]


## Run Demo
### After config the conda environment
1. python ./tools/demo.py --cfg ./experiments/coco/higher_hrnet/w32_640_adam_lr1e-3.yaml
2. (Recommend)Config in Pycharm: config the run configuratrion:
   1. choose the run file -> tools/demo.py
   2. config the parameters -> --cfg ../experiments/coco/higher_hrnet/w32_640_adam_lr1e-3.yaml
